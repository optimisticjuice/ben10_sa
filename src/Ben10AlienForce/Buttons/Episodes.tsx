  ...
  useEffect(() => {
    async function fetchEpisodes() {
      try {
       ...
       const categories = [
    "Category:Ben 10: Alien Force Season 1 Episodes",
    "Category:Ben 10: Alien Force Season 2 Episodes", 
    "Category:Ben 10: Alien Force Season 3 Episodes",
    "Category:Ben 10: Alien Force Season 4 Episodes",
];
