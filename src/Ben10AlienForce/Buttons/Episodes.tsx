...
import "./Episodes.css";
import { alienForceEpisodes } from "../../API/episode";
            ...
            loading ? (
                ...
                <div className="episodes-table">
                        <details>
                            ...
                            {alienForceEpisodes.filter(episode => episode.season === "1").map((episode) => (
                        ...
                        <details>
                            ...
                            <div className="episode-list">
                            {alienForceEpisodes.filter(episode => episode.season === "2").map((episode) => (
                                <div key={episode.id} className="episode-row">
                                    <div className="episode-number">Episode Number : {episode.id}</div>
                                    <div className="episode-title">{episode.title}</div>
                                </div>
